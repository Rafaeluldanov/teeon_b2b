/* V5 sections — premium SaaS moodboard (Teago-inspired) */

const { MarkV5, Logotype, Photo } = window;

/* ---------- NAV ---------- */
const NavV5 = () => (
  <nav className="nav">
    <a href="#" className="nav__logo">
      <Logotype size={28} color="var(--paper)" mark="var(--paper)" accent="var(--yellow)" />
    </a>
...
const HeroV5 = () => (
  <section className="hero">
    {/* Row 1 — brand-hero (5) + mark-only (3) + badge-tall (4 row-2) */}
    <div className="h-brand col-5">
      <div className="h-brand__top">
        <span className="h-brand__pill">
          <span style={{ width: 18, height: 18, borderRadius: 4, background: 'var(--yellow)', display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
            <span style={{ width: 8, height: 8, background: 'var(--ink)', borderRadius: 2 }}></span>
          </span>
          B2B · мерч с 2014
        </span>
        <span className="h-brand__pill" style={{ background: 'transparent', border: '1.5px solid rgba(10,16,46,.5)', color: 'var(--ink)' }}>
          Открыты для проектов
        </span>
      </div>

      <div className="h-brand__wm">
        <MarkV5 size={120} color="var(--ink)" accent="var(--paper)" />
        <span className="h-brand__wm-text">мерч<span className="dot">.</span>цех</span>
      </div>

      <div>
        <p className="h-brand__strap">
          <strong>Шьём промо-одежду и корпоративный мерч в собственном цехе.</strong> 9 методов нанесения, образец до тиража, тираж от 30 шт.
        </p>
        <div style={{ marginTop: 22, display: 'flex', gap: 10, flexWrap: 'wrap' }}>
          ...
          <a href="#catalog" className="btn btn--ghost-d">
            Каталог
    ...
    <div className="h-mark col-3">
      <span className="h-mark__label">Бренд-марка · 01</span>
      <MarkV5 size={210} color="var(--paper)" accent="var(--yellow)" />
      <span className="h-mark__sub">геометрия · сетка 12×12</span>
    </div>

    <div className="h-badge col-4 row-2">
      <span className="h-badge__strap"></span>
      <span className="h-badge__clip"></span>
      <div className="h-badge__card">
        <div className="h-badge__logo">
          <Logotype size={20} color="var(--paper)" mark="var(--paper)" accent="var(--yellow)" />
        </div>
        <div className="h-badge__photo">
          <svg viewBox="0 0 200 280" preserveAspectRatio="xMidYMid slice">
            <g fill="rgba(255,255,255,.16)">
              <circle cx="100" cy="100" r="38"/>
              <path d="M50 280 Q50 170 100 170 Q150 170 150 280 Z"/>
            </g>
          </svg>
        </div>
        <div>
          <div className="h-badge__name">Алексей Морозов</div>
          <div className="h-badge__role">Менеджер проектов</div>
        </div>
      </div>
    </div>

    {/* Row 2 — tag/big-number (3) + lanyard pattern (5) */}
    <div className="h-tag col-3">
      <div>
        <span className="h-tag__num">01 / Сроки</span>
        <div className="h-tag__big" style={{ marginTop: 20 }}>10–14<span className="u">дней</span></div>
      </div>
      <div className="h-tag__sub">
        От макета<br />до отгрузки —<br />прозрачный процесс.
      </div>
    </div>

    <div className="h-lanyard col-5">
      <div className="h-lanyard__strip top">
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--bg)" /> мерч.цех</span>
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--bg)" /> мерч.цех</span>
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--bg)" /> мерч.цех</span>
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--bg)" /> мерч.цех</span>
      </div>
      <div className="h-lanyard__strip bottom">
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--yellow)" /> мерч.цех</span>
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--yellow)" /> мерч.цех</span>
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--yellow)" /> мерч.цех</span>
        <span><MarkV5 size={22} color="var(--ink)" accent="var(--yellow)" /> мерч.цех</span>
      </div>
      <span className="h-lanyard__label">Лента-бейдж · мерч-пакет</span>
    </div>

    {/* Row 3 — construction (3) + tagline (3) + momentum (6) */}
    <div className="h-construct col-3">
      <div className="h-construct__lines"></div>
      <span className="h-construct__lbl">Сетка · 01</span>
      <div className="h-construct__mark">
        <MarkV5 size={180} color="var(--bg)" accent="var(--yellow)" />
      </div>
    </div>

    <div className="h-tagline col-3">
      <span className="h-tagline__ic">
        <MarkV5 size={28} color="var(--ink)" accent="var(--ink)" />
      </span>
      <div>
        <div className="h-tagline__t">9 методов<br />нанесения</div>
        <div className="h-tagline__s">вышивка · DTF · сублимация</div>
      </div>
    </div>

    <div className="h-momentum col-6">
      <div className="h-momentum__copy">
        <div className="h-momentum__t">
          Одеваем команды на полную мощность.
        </div>
        <ul className="h-momentum__bullets">
          <li>Свой цех — без посредников</li>
          <li>Образец до тиража</li>
          <li>УПД, маркировка, ТК</li>
        </ul>
        <div className="h-momentum__logo">
          <Logotype size={26} color="var(--ink)" mark="var(--ink)" accent="var(--yellow)" />
        </div>
      </div>
      <div className="h-momentum__portrait">
        <svg viewBox="0 0 200 280" preserveAspectRatio="xMidYMid slice">
          <g fill="rgba(255,255,255,.18)">
            <circle cx="100" cy="90" r="38"/>
            <path d="M48 280 Q48 160 100 160 Q152 160 152 280 Z"/>
          </g>
        </svg>
      </div>
    </div>
...
const advV5 = [
  ...
  { n: '02', t: 'Брендирование\nна площадке', d: 'Цех нанесения соседствует с пошивом — минус неделя.', bg: 'yellow' },
  { n: '03', t: 'Образец\nдо тиража',         d: 'Pre-production sample, замена брака за наш счёт.',     bg: '' },
  { n: '04', t: 'Документы\nи доставка',      d: 'УПД, договор, маркировка для WB/Ozon, ТК на выбор.',  bg: 'paper' },
];
...
const AboutV5 = () => (
  <section id="about">
    ...
    <div className="bento">
      <div className="tile yellow col-5" style={{ minHeight: 380, color: 'var(--ink)' }}>
        <div className="kicker on-light">с 2014 года</div>
        <h2 style={{ marginTop: 14, color: 'var(--ink)' }}>240<span style={{ color: 'var(--bg)' }}>+</span></h2>
        <h3 style={{ marginTop: 8, fontWeight: 600, color: 'var(--ink)' }}>проектов в год</h3>
        <p style={{ marginTop: 14, maxWidth: 420, color: 'rgba(10,16,46,.8)' }}>
        ...
        <div style={{ marginTop: 'auto', display: 'flex', gap: 8, flexWrap: 'wrap', paddingTop: 22 }}>
          {['УПД', 'Договор', 'Отсрочка', 'Маркировка'].map(t => (
            <span key={t} style={{ padding: '7px 12px', background: 'rgba(10,16,46,.12)', borderRadius: 999, fontWeight: 600, fontSize: 11.5, letterSpacing: '0.04em', color: 'var(--ink)' }}>{t}</span>
          ))}
        </div>
      </div>

      <div className="tile col-4" style={{ minHeight: 380, padding: 0 }}>
        <Photo tint="navy" kind="person" num="01/" label="Цех · Подмосковье" />
      </div>

      <div className="col-3" style={{ display: 'grid', gap: 12 }}>
        <div className="tile" style={{ minHeight: 184 }}>
          <div className="kicker">Площадь</div>
          <div className="big" style={{ marginTop: 10, color: 'var(--paper)' }}>600<span style={{ fontSize: 24, color: 'var(--yellow)', marginLeft: 4 }}>м²</span></div>
          <div className="kicker" style={{ marginTop: 'auto', color: 'var(--muted)' }}>производство + склад</div>
        </div>
        <div className="tile paper" style={{ minHeight: 184, color: 'var(--ink)' }}>
          <div className="kicker on-light">Команда</div>
          <div className="big" style={{ marginTop: 10, color: 'var(--ink)' }}>24<span style={{ fontSize: 24, color: 'var(--bg)', marginLeft: 4 }}>швеи</span></div>
          <div className="kicker on-light" style={{ marginTop: 'auto' }}>+ 6 чел. нанесение</div>
        </div>
      </div>
      ...
      <div className="tile col-6" style={{ minHeight: 220, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        ...
        <div>
          <h2 style={{ fontSize: 56, color: 'var(--paper)' }}>≈ 320 000 единиц</h2>
          <p style={{ marginTop: 12 }}>пошито и отгружено клиентам · от 30-шт. пилотов до 5 000-шт. сетевых партий</p>
        </div>
      </div>

      <div className="tile col-6" style={{ minHeight: 220, padding: 0 }}>
...
/* ---------- CATALOG ---------- */
const catV5 = [
  { slug: 'futbolki',  num: '01', name: 'Футболки',  desc: 'Хлопок 160–220 г/м², от 30 шт.',     kind: 'tee',        bg: 'bg' },
  { slug: 'hudi',      num: '02', name: 'Худи',      desc: 'Двунитка/трёхнитка с начёсом.',     kind: 'hoodie',     bg: 'yellow' },
  { slug: 'svitshoty', num: '03', name: 'Свитшоты',  desc: 'Без капюшона, плотность 280–340.',  kind: 'sweat',      bg: 'bg-2' },
  { slug: 'longslivy', num: '04', name: 'Лонгсливы', desc: 'Слим и oversize, длинный рукав.',    kind: 'longsleeve', bg: 'paper' },
  { slug: 'sumki',     num: '05', name: 'Сумки',     desc: 'Шопперы и рюкзаки, бязь и оксфорд.', kind: 'bag',        bg: 'yellow' },
  { slug: 'zhiletki',  num: '06', name: 'Жилетки',   desc: 'Утеплённые и сетчатые, под печать.', kind: 'vest',       bg: 'bg' },
  { slug: 'kurtki',    num: '07', name: 'Куртки',    desc: 'Софтшелл, ветровки, утеплённые.',    kind: 'jacket',     bg: 'bg-2' },
...
const CatalogV5 = () => (
  <section id="catalog">
    <div className="section-head">
      ...
      <p>8 базовых категорий — основа, на которую ложится любое брендирование.</p>
    </div>
      ...
      {catV5.map(c => (
        <article className="cat" key={c.slug}>
          <div className={`cat__media ${c.bg}`}>
            ...
            {renderSilhouette(c.kind, c.bg === 'paper' ? 0.55 : 0.4)}
          </div>
    ...
    <div style={{ marginTop: 20, display: 'flex', justifyContent: 'center' }}>
      <a href="/catalog/" className="btn btn--yellow">
...
const brV5 = [
  ...
  { slug: 'dtf',         num: '03', t: 'DTF',         d: 'Полноцветная плёнка, фото и детали.',     tags: ['CMYK+W', 'от 1 шт'],     bg: '' },
  { slug: 'dtg',         num: '04', t: 'DTG',         d: 'Прямая печать по ткани, фото-кач.',        tags: ['от 1 шт', 'all-over'],   bg: 'paper' },
  ...
  { slug: 'deboss',      num: '07', t: 'Тиснение',    d: 'Сухое и фольгированное по коже.',          tags: ['фольга', 'клише'],       bg: '' },
  { slug: 'laser',       num: '08', t: 'Гравировка',  d: 'Лазер по металлу, дереву, коже.',          tags: ['от 1 шт', 'без краски'], bg: '' },
  { slug: 'labels',      num: '09', t: 'Бирки',       d: 'Тканые, кожаные, бумажные — финал.',       tags: ['жаккард', 'крой'],       bg: 'paper' },
];
...
const WorkV5 = () => (
  <section id="how-we-work">
    <div className="section-head">
      ...
      <p>От первого звонка до отгрузки — прозрачный процесс. Образец до тиража, статус заказа в реальном времени.</p>
    </div>
...
const ptV5 = [
  ...
  { slug: 'event',       type: 'Event-агентство', t: 'Форма для open-air фестиваля',       task: 'Худи и кепки',  ed: '180 шт',   tech: 'Шелкография',    term: '9 дней',  date: '02.05.26', kind: 'cap',        bg: 'bg' },
  { slug: 'sport',       type: 'Спорт-клуб',      t: 'Форма для любительской лиги',        task: 'Игровая',       ed: '90 комп.', tech: 'Сублимация',     term: '14 дней', date: '21.04.26', kind: 'tee',        bg: 'bg-2' },
  ...
  { slug: 'coffee',      type: 'Кофейня',         t: 'Фартуки и футболки барист',          task: 'Униформа',      ed: '45 шт',    tech: 'Вышивка',        term: '8 дней',  date: '15.03.26', kind: 'vest',       bg: 'bg' },
];
...
const PortfolioV5 = () => (
  <section id="portfolio">
    <div className="section-head">
      ...
      <p>Шесть из последних кейсов: от welcome-наборов для IT до тиражей в 1 200 шопперов для ритейл-сети.</p>
    </div>
      ...
      {ptV5.map(c => (
        <article className="case" key={c.slug}>
          <div className={`case__media ${c.bg}`}>
            ...
            {renderSilhouette(c.kind, c.bg === 'paper' ? 0.5 : 0.45)}
          </div>
          <div className="case__body">
            ...
            <div className="case__actions">
              ...
              <a href="#request" style={{ color: 'var(--yellow)', fontWeight: 700, fontSize: 12.5, letterSpacing: '0.02em', textTransform: 'uppercase', whiteSpace: 'nowrap', marginLeft: 'auto' }}>
                Рассчитать похожий →
              </a>
            </div>
          </div>
...
const clV5 = [
  ...
  { mark: 'SP', n: 'Спортивный клуб',     tp: 'Любительская лига',     bg: 'paper' },
  ...
  { mark: 'MA', n: 'Маркетинг-агент.',    tp: 'B2B-промо',             bg: 'paper' },
];
...
const fqV5 = [
  ...
  { q: 'Как происходит доставка?', a: 'По Москве — собственный курьер или СДЭК. По России — ТК на выбор (Деловые Линии, Байкал, ПЭК, СДЭК).' },
];
...
const SeoV5 = () => (
  <section className="seo">
    <div>
      <div className="kicker on-light" style={{ marginBottom: 16 }}>(09) — Подробнее</div>
  ...
  return (
    <section id="request">
      <div className="section-head">
        ...
        <p>Заполните форму — менеджер свяжется в течение часа в рабочее время.</p>
      </div>
        ...
        <form className="form" onSubmit={e => { e.preventDefault(); setSent(true); }}>
          {sent ? (
            <div style={{ padding: '60px 0', textAlign: 'center' }}>
              ...
              <div style={{ fontFamily: 'var(--display)', fontSize: 36, fontWeight: 800, letterSpacing: '-0.03em', marginBottom: 10, color: 'var(--paper)' }}>
                Заявка принята
              </div>
      ...
      <div className="strip__track">
        {loop.map((t, i) => (
          <React.Fragment key={i}>
            ...
            <span className="star">
              <MarkV5 size={28} color="var(--ink)" accent="var(--bg)" />
            </span>
          </React.Fragment>
        ))}
      </div>
