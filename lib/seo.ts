...
export const siteConfig = {
  ...
  defaultDescription:
    'Производим корпоративный мерч и промо-одежду на заказ для компаний по всей России: футболки, худи, свитшоты, сумки, куртки и брендирование. Собственное производство в Москве, документы для B2B и расчёт под задачу.',
