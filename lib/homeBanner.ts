...
export const defaultHomeBanner: HomeBannerContent = {
  title: 'Пошив корпоративного мерча и <em>промо-одежды</em> на заказ',
  subtitle: 'Мерч без сорванных сроков, брака и лишних наценок: фиксируем сроки в договоре, делаем образец перед тиражом и контролируем пошив, нанесение и упаковку на своём производстве.',
