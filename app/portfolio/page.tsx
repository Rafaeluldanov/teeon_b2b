...
export const metadata: Metadata = {
  ...
  description:
    'Примеры работ по пошиву промо-одежды, корпоративного мерча и брендированных изделий для бизнеса: футболки, худи, свитшоты, сумки, жилетки, куртки, дождевики и нанесение логотипов.',
